...
import kotlinx.android.synthetic.main.fragment_trees_list_nested.*


class NestedTreesFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recycler_view.apply {
            adapter = ParentNestedAdapter(createData())
        }
    }
    ...
    companion object {
        fun newInstance() = NestedTreesFragment()
    }
}